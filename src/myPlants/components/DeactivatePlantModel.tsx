...
// export const DeactivatePlantModal: React.FC = () => {
...
//   return (
//     <div className="flex flex-col p-4 bg-white rounded-2xl max-w-[300px]">
//       <div className="flex flex-col p-2 w-full text-center">
//         <div className="text-base font-extrabold tracking-normal text-neutral-800">
//           {modalConfig.title}
//         </div>
...
//         </div>
//       </div>
//       <div className="flex gap-2 items-start mt-5 w-full text-xs font-semibold whitespace-nowrap">
